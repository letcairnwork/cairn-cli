 ...
 * Adds personalized agent-skill.md to workspace context
 */
export async function setupClaudeCode({ workspacePath, agentName }) {
  ...
  // Write personalized skill to workspace
